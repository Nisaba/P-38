package models {
    ...
    // https://github.com/MSchmidt/DieKnipse/blob/master/as3-model/UploadPostHelper.as
	...
	public class UploadPostHelper {
		 ...
		 */
		public static function getPostData(pFilename:String, byteArray:ByteArray, parameters:Object = null):ByteArray {
			...
			bytes = 'Content-Disposition: form-data; name="file"; filename="' + pFilename + '"';
